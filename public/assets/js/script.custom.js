...
;(function ($, window, document, undefined) {
	...
	KedaiKopi = {
		...
		documentReady:function(){
			KedaiKopi.counterNumber(); //Count
			KedaiKopi.initSlide(); //Carousel
			if( !KedaiKopi.isMobile() ) KedaiKopi.initStickyNav(); //Sticky Menu
			KedaiKopi.goToTop(); //Scroll
			KedaiKopi.toogleMenu(); //Toogle Menu
			KedaiKopi.initFancy(); //Init FancyBox
			KedaiKopi.selectTable(); //Event Select Table
			KedaiKopi.controlForm(); // Control Form
		},

		windowLoad: function(){
			KedaiKopi.configGmaps(40.713905,-74.009190); //Configuration Gmaps (lat,long)
			KedaiKopi.configListingMenu(); //Configuration ListingMenu
			if( !KedaiKopi.isMobile() ) KedaiKopi.configParallax(); //Parallax
			KedaiKopi.loaderPage(); //Call Function Remove Loader Page
		},
	...
	_doc.ready(KedaiKopi.documentReady);
	/*============================================ Call Functions on Window.Load ============================================*/
	_win.load(KedaiKopi.windowLoad);
